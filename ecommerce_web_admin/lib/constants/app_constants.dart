...
class AppConstants {
  // App Info
  static const String appName = 'ShopGram Admin App';
  ...
  static const String buyersEndpoint = '$baseUrl/api/users';
  ...
  static const String vendorEndpoint = '$baseUrl/api/vendors';
